...
`$ wget -c https://github.com/rebuy-de/aws-nuke/releases/download/v1.0.1/aws-nuke-v1.0.1-linux-amd64.tar.gz -O - | tar -xz -C $HOME/bin`

Run
`$ aws-nuke-v1.0.1-linux-amd64`
